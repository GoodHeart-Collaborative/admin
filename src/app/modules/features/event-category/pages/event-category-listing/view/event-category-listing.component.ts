...
import { CategoryTableDataSource } from '../../../model';
...
@Component({
  ...
  templateUrl: './event-category-listing.component.html',
  styleUrls: ['./event-category-listing.component.scss']
})
export class EventCategoryListingComponent implements OnInit {
